...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('resume_app_category', (
            ...
            ('skills', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resume_app.Skills'], max_length=50)),
        ))
    ...
    models = {
        'resume_app.category': {
            ...
            'skills': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['resume_app.Skills']", 'max_length': '50'})
        },
