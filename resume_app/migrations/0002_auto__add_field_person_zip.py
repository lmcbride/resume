...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.zip'
        db.add_column('resume_app_person', 'zip',
                      self.gf('django.db.models.fields.IntegerField')(default=True, max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.zip'
        db.delete_column('resume_app_person', 'zip')
