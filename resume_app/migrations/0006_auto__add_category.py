...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('resume_app_category', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resume_app.Skills'])),
        ))
    ...
    models = {
        'resume_app.category': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['resume_app.Skills']"}),
