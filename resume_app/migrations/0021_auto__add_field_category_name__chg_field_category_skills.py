...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('resume_app_category', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


        # Changing field 'Category.skills'
        db.alter_column('resume_app_category', 'skills_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resume_app.Skills']))

    def backwards(self, orm):
        # Deleting field 'Category.name'
        db.delete_column('resume_app_category', 'name')


        # Changing field 'Category.skills'
        db.alter_column('resume_app_category', 'skills_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resume_app.Skills'], max_length=50))
    ...
    models = {
        'resume_app.category': {
            ...
            'skills': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['resume_app.Skills']"})
        },
