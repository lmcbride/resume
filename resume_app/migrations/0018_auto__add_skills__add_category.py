...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('resume_app_skills', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resume_app.Category'], max_length=50)),
        ))
    ...
    models = {
        ...
        'resume_app.skills': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['resume_app.Category']", 'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
